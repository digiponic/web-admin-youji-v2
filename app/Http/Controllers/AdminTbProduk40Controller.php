<?php namespace App\Http\Controllers;
	...
	class AdminTbProduk40Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Gudang Keterangan","name"=>"gudang_keterangan"];
			...
			$this->form[] = ['label'=>'Pindah Ke-','name'=>'gudang','type'=>'select2','validation'=>'required','width'=>'col-sm-10','datatable'=>'tb_general,keterangan','datatable_where'=>'kode_tipe = 8'];
			$columns[] = ['label'=>'Produk','name'=>'kode_produk','required'=>true,'type'=>'datamodal','datamodal_table'=>'tb_produk','datamodal_columns'=>'keterangan,stok,satuan_keterangan','datamodal_columns_alias'=>'Produk,Stok,Satuan','datamodal_select_to'=>'harga:harga,satuan_keterangan:satuan_keterangan','datamodal_where'=>'stok != 0','datamodal_size'=>'large'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Cabang","name"=>"cabang","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Gudang","name"=>"gudang","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Gudang Keterangan","name"=>"gudang_keterangan","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
