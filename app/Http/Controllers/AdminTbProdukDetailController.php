<?php namespace App\Http\Controllers;
	...
	class AdminTbProdukDetailController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tb_produk_detail";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Bahan","name"=>"kode_produk2","join"=>"tb_produk,keterangan"];
			$this->col[] = ["label"=>"Takaran","name"=>"takaran"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Produk','name'=>'kode_produk','type'=>'hidden'];
			...
			//$this->form[] = ['label'=>'Takaran','name'=>'takaran','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10','value'=>0];
			//$this->form[] = ['label'=>'Satuan','name'=>'satuan','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tb_general,keterangan','datatable_where'=>'kode_tipe = 5'];
			# OLD END FORM
