<?php namespace App\Http\Controllers;
	...
	class AdminTbKurirController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$kode = 'KRR/'.str_pad($kode,5,0,STR_PAD_LEFT);
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Kode Kurir","name"=>"kode_kurir","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			...
			//$this->form[] = ["label"=>"Deleted-at","name"=>"deleted-at","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			# OLD END FORM
