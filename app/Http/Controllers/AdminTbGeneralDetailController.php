<?php namespace App\Http\Controllers;
	...
	class AdminTbGeneralDetailController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$kode = DB::table('tb_general_detail')->max('id') + 1;
			$kode = 'INVT/'.date('dmy').'/'.str_pad($kode, 5, 0, STR_PAD_LEFT);

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Kode General','name'=>'kode_general','type'=>'hidden'];
