<?php namespace App\Http\Controllers;
	...
	class AdminTbKecamatanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$kode = DB::table('tb_kecamatan')->max('id') + 1;
			$kode = 'SUBAREA2/'.str_pad($kode,3,0,STR_PAD_LEFT);
	        ...
	        */
			...
			// $this->sub_module[] = ['label'=>'','path'=>'tb_kelurahan','parent_columns'=>'keterangan','parent_columns_alias'=>'Kecamatan','foreign_key'=>'kode_kecamatan','button_color'=>'info','button_icon'=>'fa fa-flag-o'];
	    ...
	    */
	    public function actionButtonSelected($id_selected,$button_name) {
			...
			if($button_name == 'set_visible') {
				DB::table('tb_kecamatan')->whereIn('id',$id_selected)->update(['is_visible'=>'1']);
			}

			if($button_name == 'set_not_visible') {
				DB::table('tb_kecamatan')->whereIn('id',$id_selected)->update(['is_visible'=>'0']);
			}
	    }
