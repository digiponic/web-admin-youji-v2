<?php namespace App\Http\Controllers;
	...
	class AdminTbSurveyController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Meteran","name"=>"meteran"];
			...
			$this->form[] = ['label'=>'Meteran','name'=>'meteran','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
	    ...
	    */
	    public function hook_before_add(&$postdata) {
	        //Your code here
			  $postdata['bulan'] = date('n',strtotime($postdata['tanggal']));
