<?php namespace App\Http\Controllers;
	...
	class AdminTbProdukStokController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tb_produk_stok_bahan";
	    ...
	    */
	    public function hook_after_add($id) {
	        //Your code here
			// $produk = CRUDBooster::first('tb_produk',Request::get('kode_produk'));
			$produk_id = Request::get('kode_produk');
			$produk = DB::table('tb_produk')->where('id', $produk_id)->get();
	    	$stok = $produk[0]->stok_bahan + Request::get('stok_masuk') - Request::get('stok_keluar');
	    	DB::table('tb_produk')->where('id', $produk_id)->update(['stok_bahan'=>$stok]);
	    }
