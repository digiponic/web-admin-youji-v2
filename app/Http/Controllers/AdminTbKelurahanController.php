<?php namespace App\Http\Controllers;
	...
	class AdminTbKelurahanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tb_kelurahan";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Kelurahan","name"=>"keterangan"];
			$this->col[] = ["label"=>"Kodepos","name"=>"kodepos"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Keterangan','name'=>'keterangan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kodepos','name'=>'kodepos','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Kodepos","name"=>"kodepos","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Created User Id","name"=>"created_user_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"created_user,id"];
