<?php namespace App\Http\Controllers;
	...
	class AdminTbProdukStokJualController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tb_produk_stok_jual";
			...
			$this->col[] = ["label"=>"Dibuat oleh","name"=>"created_user"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Kode Produk','name'=>'kode_produk','type'=>'hidden','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tanggal','name'=>'tanggal','type'=>'datetime','validation'=>'required','width'=>'col-sm-10','readonly'=>true,'value'=>$date];
			...
			$this->form[] = ['label'=>'Keterangan','name'=>'keterangan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','placeholder'=>'Cth: Opname stok | penyesuaian stok'];
	    ...
	    */
	    public function hook_after_add($id) {        
	    	...
	    	$stok = $produk[0]->stok_jual + Request::get('stok_masuk') - Request::get('stok_keluar');
	    	DB::table('tb_produk')->where('id', $produk_id)->update(['stok_jual'=>$stok]);
	    }
